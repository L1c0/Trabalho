...
import {reel02 as R, type Fala} from '../data/reel02';
...
// Trilha: entra com o papel, abaixa 3 dB sob a voz (release 400 ms), corta seco no fim.
  ...
  return (
    <Sequence name="trilha" from={t.de} durationInFrames={t.ate - t.de} layout="none">
      <Html5Audio
        ...
        volume={(f) => dbParaVolume(t.duckingDb * presencaDaVoz(f + t.de, R.falas, t.ataque, t.release))}
      />
    </Sequence>
  );
};
